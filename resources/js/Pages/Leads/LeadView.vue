        ...
        <div class="container">
            ...
            <div class="card mt-3" v-if="lead.reminders.length > 0">
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-sm-12">
                            <inertia-link class="btn btn-success float-right mb-2" :href="$route('reminder.add', {lead: leadProp})">
                                Add a reminder
                            </inertia-link>
                        </div>
                    </div>
            ...
            <div class="card mt-3" v-if="lead.reminders.length == 0">
                ...
                <div class="card-body d-flex justify-content-center">
                    <inertia-link class="btn btn-success" :href="$route('reminder.add', {lead: leadProp})">
                        Add a reminder
                    </inertia-link>
                </div>
            </div>
