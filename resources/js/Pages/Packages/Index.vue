                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <ul class="list-group list-group-flush" v-if="activePackages.length > 0">
                                <li class="list-group-item" v-for="activePackage in activePackages" :key="activePackage.id">
                                    <inertia-link :href="$route('package.view', {package: activePackage})">
                                        {{activePackage.name}} ({{activePackage.number_of_days}} days)
                                    </inertia-link>
                                    <span class="float-right"><strong>₹ {{activePackage.amount}}</strong></span>
                                </li>
                            </ul>
