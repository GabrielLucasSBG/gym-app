<template>
    <form @submit.prevent="handleSubmit">
        <div class="row">
            <div class="col-md-6">
                ...
                <div class="form-group">
                    ...
                    <select name="ip" id="ip" class="form-control" v-model="lead.interested_package" tabindex="5">
                        <option v-for="(option, key) in packages" v-bind:value="option.name" :key="key">
            ...
            <div class="col-md-6">
                ...
                <div class="form-group">
                    ...
                    <input type="number" class="form-control" placeholder="Enter age" v-model="lead.age" id="age" tabindex="6" disabled>
                </div>
            </div>
        </div>
        ...
        <div class="row">
            ...
            <div class="col-md-6">
                <inertia-link class="btn btn-success float-right" :href="$route('lead.subscribe', {lead: mainLead})">
                    Make subscriber
                </inertia-link>
            </div>
        </div>
